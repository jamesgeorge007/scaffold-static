...
const scaffoleProj = (projectName) => {
    ...
    setTimeout(() => {
      ...
      .then(choice => {
        ...
        execSync('mkdir static');
        execSync('cd static');
        execSync('mkdir stylesheets');
        execSync('notepad ./static/stylesheets/style.css');
        execSync('notepad ./static/main.js');
        fs.writeFileSync('./static/stylesheets/style.css', '// Write your rulesets here!');
        fs.writeFileSync('./static/main.js', '// Any sorts of JavaScript code goes here!');
        ...
        if(choice.framework === 'Bootstrap-3'){
            ...
            fs.writeFileSync('./index.html', foundationFile);
            opn('./index.html');
            console.log(chalk.green('\n Serving website within your default browser!'));    
        } else if(choice.framework === 'Semantic-UI'){
            fs.writeFileSync('./index.html', semanticUiFile);
            opn('./index.html');
            console.log(chalk.green('\n Serving website within your default browser!'));    
        } else if(choice.framework === 'Bulma'){
            fs.writeFileSync('./index.html', bulmaFile);
            opn('./index.html');
            console.log(chalk.green('\n Serving website within your default browser!'));    
        }
      });
